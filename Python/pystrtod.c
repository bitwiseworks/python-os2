...
#ifdef __OS2__
    /* @todo: Quick hack: disable FPU exceptions to avoid unexpected
       SIGFPE. The proper way is to fix compiler runtime so that its
       exception handler undoes FPU CW reset caused by bogus OS/2 DLLs. */
