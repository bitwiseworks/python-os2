...
class Popen:
    ...
    def __init__(self, args, bufsize=-1, executable=None,
                 ...
                 process_group=None, threadsafe=None):
        ...
        if _mswindows or _os2:
            if preexec_fn is not None:
                raise ValueError("preexec_fn is not supported on Windows or OS/2 "
                                 "platforms")
        else:
            # POSIX
        ...
        try:
            ...
            self._execute_child(args, executable, preexec_fn, close_fds,
                                pass_fds, cwd, env,
                                startupinfo, creationflags, threadsafe, shell,
                                p2cread, p2cwrite,
                                c2pread, c2pwrite,
                                errread, errwrite,
                                restore_signals,
    ...
    if _mswindows:
        ...
        def _execute_child(self, args, executable, preexec_fn, close_fds,
            ...
            if shell:
                ...
                unix_shell = sysconfig.get_config_var('SHELL') or ('/system/bin/sh' if
